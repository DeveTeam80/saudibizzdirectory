...
export const categoryData: CategoryData[] = [
  {
    ...
    title: 'Real Estate',
    list: '25+ Listings',
    link: '/real-estate/main',
  },
  {
    icon: LiaIndustrySolid,
    title: 'Manufacturing',
    list: '40+ Listings',
    link: '/manufacturing/main',
  },
  {
    icon: BsShop,
    title: 'Shops & Suppliers',
    list: '80+ Listings',
    link: '/shops-and-suppliers/main',
  },
  {
    icon: FaBriefcaseMedical,
    title: 'Health & Services',
    list: '30+ Listings',
    link: '/services/main', // Assuming a link for this page
  },
  {
    icon: GiWheat,
    title: 'Agribusiness',
    list: '18+ Listings',
    link: '/agribusiness/main', // Assuming a link for this page
  },
  {
    icon: FaLaptopCode,
    title: 'IT & Innovation',
    list: '22+ Listings',
    link: '/technology/main', // Assuming a link for this page
  },
];
...
export const footerLink1  = ['About SaudiBizzDirectory','Submit Listing','SaudiBizzDirectory Report','Careers']

export const footerLink2  = ['Trust & Safety','Investor Relations','Terms of Services','Paid Advertising','SaudiBizzDirectory Blog']

export const footerLink3  = ['Trust & Safety','Investor Relations','Terms of Services','Paid Advertising','SaudiBizzDirectory Blog']
