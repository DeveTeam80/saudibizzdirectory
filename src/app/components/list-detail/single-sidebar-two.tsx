            ...
            <div className="card">
                <div className="">
                    <div className="avatarBox my-4">
                        <div className="square--100 circle bg-light mx-auto mb-2 p-2"><Image src='/img/team-4.jpg' width={0} height={0} sizes='100vw' style={{width:'100%', height:'100%'}} className="img-fluid circle" alt="Avatar"/></div>
