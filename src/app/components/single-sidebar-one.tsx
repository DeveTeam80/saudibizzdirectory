...
export default function SingleSidebarOne() {
    ...
    const personal = [
        ...
        },
        {
          ...
          title:'Website',
          desc:'www.SaudiBizzDirectory.co.in'  
        },
    ]
    const social = [
        {
  ...
  return (
        <div className="sidebarGroups d-flex flex-column gap-4">
            ...
            <div className="card">
                ...
                <div className="card-body mt-n3 p-0">
                    <div className="avatarBox position-relative mb-4">
                        <div className="square--100 circle bg-transparents mx-auto p-2 z-2"><Image src='/img/team-4.jpg' width={0} height={0} sizes='100vw' style={{width:'100%', height:'100%'}} className="img-fluid circle" alt="Avatar"/></div>
            ...
            <div className="card p-0">
                <div className="card-header bg-cover ht-150" style={{backgroundImage:`url('/img/avatar-bg-2.jpg')`}} data-overlay="4"></div>
