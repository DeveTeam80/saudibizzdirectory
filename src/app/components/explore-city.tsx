...
import { cityData, CityData as CityType } from '../data/data'

export default function ExploreCity() {
    return (
        <div className="row align-items-center justify-content-center g-4">
            {cityData.map((item: CityType, index: number) => {
                return (
                            ...
                            <div className="position-absolute bottom-0 start-0 mb-3 ms-3 z-1">
                                <div className="d-block w-100 position-relative">
                                    ...
                                    <div className="d-flex align-items-center justify-content-start flex-wrap gap-2">
                                        {item.tag.map((el, tagIndex) => {
                                            return (
                                                <span 
                                                    className="badge badge-xs badge-transparent rounded-pill" 
                                                    key={tagIndex}
                                                >
                                                    {el}
                                                </span>
