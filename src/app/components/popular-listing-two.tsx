                                ...
                                <div className="singlelisting-item">
                                    ...
                                    <div className="listing-middle-item">
                                        <div className="listing-avatar">
                                            <Link href="/single-listing-01" className="avatarImg"><Image src={item.user} width={0} height={0} sizes='100vh' style={{width:'100%', height:'auto'}} className="img-fluid circle" alt="Avatar"/></Link>
                                        </div>
