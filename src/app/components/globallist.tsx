...
export default function GlobalList({ relatedListings }: GlobalListProps) {
                          ...
                          <div className="d-flex align-items-center justify-content-between gap-2">
                            <div className="listing-details">
                              <h4 className="listingTitle">
                                <Link href={`/global-listings/${displayCategory?.slug}/${item.slug}`} className="titleLink text-white">
                                  {item.title}
                                  {item.isVerified && (
