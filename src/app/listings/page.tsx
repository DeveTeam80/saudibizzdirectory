...
export default async function AllListingsPage({
    ...
    const [{ listings, totalPages, totalItems }, subCategories, cities] = await Promise.all([
        getListings(ListingContext.LOCAL, filterParams, currentPage, itemsPerPage),
        getSubCategories(undefined, ListingContext.LOCAL),
        getCities(undefined, ListingContext.LOCAL)
    ]);

    // Breadcrumb items for all listings page
                    ...
                    <div className="row justify-content-start align-items-start">
                        <div className="col-xl-8 col-lg-10 col-md-12 col-sm-12">
                            <div className="position-relative text-start py-4 mt-lg-0 mt-5">
                                <h2>All Business Listings</h2>
                                <p>Discover trusted businesses and services across all categories in our comprehensive directory.</p>
...
export async function generateMetadata(): Promise<Metadata> {
    return generateSEOMetadata('/listings');
}